...
DAEMON_ARGS="/home/pi/home/currnet/index.js"               # path to your node.js server/app
                                            # NB: don't use ~/ in path

DESC="Assistant Router"                  # whatever fancy description you like

NODEUSER=pi:pi                     # USER who OWNS the daemon process (no matter whoever runs the init script)
...
NAME=nodejs                                   # name of the node.js executable
